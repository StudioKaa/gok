		...
		@if(!$member->hasCompleteEnrollment())
			<div class="page front">
				...
				<div class="content pull-up">
					...
					<p>In het weekend van 1, 2 en 3 juni 2018. De camping gaat op vrijdag al open. De officiële opening is zaterdag om 12:00u. Zaterdag en zondag zijn er georganiseerde activiteiten.</p>
					...
					<p>Twijfelt u nog? Heeft u een vraag? Op de achterkant van deze brief staan een aantal veelgestelde vragen, maar aarzel ook niet om contact op te nemen! Mail ons op <a href="mailto:gok@scoutingrveer.nl">gok@scoutingrveer.nl</a> of stuur een berichtje via Facebook: <a href="https://m.me/scoutingrveer">facebook.com/scoutingrveer</a>.</p>

					<p>We zien uw inschrijving of vragen graag tegemoet!</p>
			...
			<div class="page back columns content">
				...
				<div>
					...
					<p>We bouwen onze camping op in een prachtig natuurgebied in Zeewolde. Dat is ongeveer 90km rijden vanaf Raamsdonksveer. Onze camping ligt aan het water. Binnendijks zijn de kampeerplaatsen in een prachtig bosgebied met veel vennen en slootjes. Buitendijks zijn een aantal strandjes, een aanlegsteiger en veel speelvelden.</p>
					
					<h3>Kan onze zoon/dochter niet zelf mee?</h3>
				...
				<div>
					...
					<p>Daarnaast is er de bar waar je de hele dag fris en wat lekker kunt halen, en 's avonds ook bier en wijn. Hiervoor betaal je met muntjes. Schrijf je je voor 1 maart in, dan ontvang je een muntje gratis!</p>
